      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-white mb-2">{t.home.trustedBy}</h2>
            <p className="text-gray-300">{t.home.trustedSub}</p>
          </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="text-center md:text-left flex-1">
                    <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm text-white text-sm px-3 py-1 rounded-full mb-4">
                      ...
                      <span className="font-medium">{t.home.limitedOffer}</span>
                    </div>
                  ...
                  <div className="hidden md:block">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                      <div className="text-white text-sm font-medium mb-4">{t.home.benefitsTitle}</div>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[t.methods.pt, t.methods.mt, t.methods.ut, t.methods.et, t.methods.paut, t.methods.rt].map((m, index) => (
              <div
                key={m.name}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">{t.home.upcomingSub}</p>
            </div>
          ...
          {events.length > 0 && (
            <div className="mt-6 text-center">
              <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-800 text-sm px-4 py-2 rounded-full">
                <span className="font-medium">{t.home.important}</span> {t.home.quotaWarning}
              </div>
            </div>
          )}
        </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex items-end justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">{t.home.featuredTitle}</h2>
              <p className="text-gray-600 text-sm">{t.home.featuredSub}</p>
            </div>
            <Link to="/courses" className="text-sm text-gray-700 hover:text-gray-900">{t.home.allCourses}</Link>
          </div>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-8 sm:py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 container-mobile">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4 heading-responsive">{t.home.testimonialTitle}</h2>
              ...
              >
                ...
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-100">
                  <div className="flex items-center text-xs text-gray-500">
                    ...
                    {index === 0 ? `${t.home.graduated} 2024` : index === 1 ? `${t.home.graduated} 2023` : `${t.home.graduated} 2023`}
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="mt-8 sm:mt-12 text-center">
            <div className="inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-orange-50 to-blue-50 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl border border-orange-200">
              ...
              <div className="text-xs sm:text-sm text-gray-700">
                <span className="font-semibold text-orange-600">500+</span> {t.home.alumniIndustry}
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="text-center">
            <div className="text-sm text-gray-600">{t.home.trustedCompanies}</div>
      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
          <div className="rounded-xl border border-gray-200 bg-white p-8 md:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900">{t.home.readyTitle}</h3>
              <p className="text-gray-600 mt-1">{t.home.readySub}</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="rounded-lg border border-gray-200 p-5">
              <div className="flex items-center gap-2 text-gray-900 font-medium"><Users className="h-4 w-4" /> {t.home.corpConsult}</div>
              <p className="mt-2 text-sm text-gray-600">{t.home.corpDesc}</p>
              <div className="mt-4 flex gap-3">
                ...
                <a href="/courses" className="rounded-md bg-gray-900 text-white px-4 py-2 text-sm hover:bg-black">{t.home.viewCourses}</a>
              </div>
            </div>
          </div>
        </div>
